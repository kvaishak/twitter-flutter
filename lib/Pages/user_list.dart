          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            if(snapshot.hasData){
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) => UserCard(context, index, snapshot));
            }else {
          ...
          children: <Widget>[
            ListTile(
              leading: CircleAvatar(
                radius: 30,
                backgroundImage: NetworkImage("https://ssl.gstatic.com/accounts/ui/avatar_2x.png"),),
              title: Text(_name(snapshot.data[index])),
              subtitle: Text("@"+_username(snapshot.data[index])),
              onTap: () {
                Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Profile(profiledata:  Profiledata(name:_username(snapshot.data[index])),)),
